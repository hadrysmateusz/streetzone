...
const translateFirebaseError = (error) => {
  ...
  switch (errorCode) {
    ...
    case "auth/user-disabled":
      return `To konto zostało zablokowane. Jeśli uważasz że to pomyłka, skontaktuj się z nami na: ${CONST.CONTACT_EMAIL}`
...
const translateErrorMessage = (error) => {
  return applyHandlers(error, [translateFirebaseError, getMessage])
}
