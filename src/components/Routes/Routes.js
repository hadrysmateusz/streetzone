...
const SignIn = Loadable({
  loader: () => import("../../pages/Auth/SignIn/SignInPage"),
  loading: LoadableComponentSpinner,
})
const PasswordForget = Loadable({
  loader: () => import("../../pages/Auth/PasswordForgetPage"),
  loading: LoadableComponentSpinner,
})
...
// ===== DEALS =====
const Deal = Loadable({
  loader: () => import("../../pages/Deal/DealPage"),
  loading: LoadableComponentSpinner,
})
...
const ChatNew = Loadable({
  loader: () => import("../../pages/Chat/NewChat"),
  loading: LoadableComponentSpinner,
})
const Chat = Loadable({
